...
export function PhoneMockup() {
  return (
    ...
    <div
      dir="ltr"
      className="w-[260px] rounded-[2.5rem] border-[10px] border-ink-fixed bg-ink-fixed p-1.5 shadow-2xl"
    >
      <div className="relative h-[520px] overflow-hidden rounded-[2rem] bg-white dark:bg-[#1c1810]">
        <div className="absolute left-1/2 top-2 z-10 h-5 w-24 -translate-x-1/2 rounded-full bg-ink-fixed" />
        <div className="flex h-full flex-col gap-3 px-4 pt-9 pb-5">
          <p className="text-xs font-semibold text-gray-400">Today&apos;s overview</p>
