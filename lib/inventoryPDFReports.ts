...
// feel like part of the same Froshiar PDF system.
...
<div class="page">
  ...
  <div class="footer">
    ${isKurdish
      ? `${ku(escHtml(t('generatedBy')))} ${escHtml(business.name || 'Business')} &middot; ${ku(i18n.t('common.developedBy') as string)} ${i18n.t('common.appName')} · ${PDF_BRAND_WEBSITE} &middot; ${dateStr} &middot; ${timeStr}`
      : `Generated By: <strong>${escHtml(business.name || 'Business')}</strong> &middot; ${i18n.t('common.developedBy')} ${i18n.t('common.appName')} · ${PDF_BRAND_WEBSITE} &middot; ${dateStr} at ${timeStr}`}
  </div>
