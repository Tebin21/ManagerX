...
<div class="page">
  ...
  <div class="footer">
    ${isKurdish
      ? `${ku(escHtml(t('generatedBy')))} ${escHtml(business.name || 'Business')} &middot; ${t('common.appName')} &middot; ${dateStr} &middot; ${timeStr}`
      : `Generated By: <strong>${escHtml(business.name || 'Business')}</strong> &middot; ${t('common.appName')} &middot; ${dateStr} at ${timeStr}`}
  </div>
