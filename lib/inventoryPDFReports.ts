...
<div class="page">
  ...
  <div class="footer">
    ${isKurdish
      ? `${ku(escHtml(t('generatedBy')))} ${escHtml(business.name || 'Business')} &middot; ${ku(pdfDevelopedByText())} · ${PDF_BRAND_WEBSITE} &middot; ${dateStr} &middot; ${timeStr}`
      : `Generated By: <strong>${escHtml(business.name || 'Business')}</strong> &middot; ${pdfDevelopedByText()} · ${PDF_BRAND_WEBSITE} &middot; ${dateStr} at ${timeStr}`}
  </div>
