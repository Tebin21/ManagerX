...
import { KURDISH_FONT_FACE, PDF_BRAND_WEBSITE, PDF_DEVELOPED_BY_EN } from '@/lib/pdfFont';
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .total-row td { background: #FBF7EA; font-weight: 700; color: #3B300C; border-top: 2px solid #EFE1B3; }
...
<div class="page">
  ...
  <div class="section">
    ...
    <div class="pl-row">
      ...
      <span class="pl-value" style="color:#5D4C14;">${fmtIQD(plData?.grossRevenue ?? 0)} IQD</span>
    </div>
  ...
  <div class="footer">
    <p>Generated by <strong>${escHtml(business.name)}</strong> &middot; ${PDF_DEVELOPED_BY_EN} &middot; ${PDF_BRAND_WEBSITE} &middot; ${fmtDateTime(new Date().toISOString())}</p>
  </div>
