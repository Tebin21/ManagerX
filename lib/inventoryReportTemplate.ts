...
<div class="page">
  ...
  <div class="footer">
    ${isKurdish ? escHtml(t('generatedBy')) : 'Generated by'} ${isKurdish ? escHtml(business.name) : `<strong>${escHtml(business.name)}</strong>`} &middot; ${t('common.appName')} &middot; ${dateStr} at ${timeStr}
  </div>
